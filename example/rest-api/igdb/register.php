...
function register_igdb_game_block() {
	$block_name   = 'IGDB Game';
	...
	$igdb_datasource  = new IGDBDatasource();
	$list_games_query = new IGDBListGamesQuery( $igdb_datasource );
	$get_game_query   = new IGDBGetGameQuery( $igdb_datasource );
	...
	ConfigurationLoader::register_block( $block_name, $list_games_query );
...
add_action( 'register_remote_data_blocks', __NAMESPACE__ . '\\register_igdb_blocks' );
