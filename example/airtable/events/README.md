...
For most use cases, you can register these blocks [without writing any code](https://remotedatablocks.com/gh/docs/workflows/airtable/). However, if you want to customize the block output or behavior, registering these blocks in code can give you more flexibility.
