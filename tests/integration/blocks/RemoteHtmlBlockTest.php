...
class RemoteHtmlBlockTest extends RDBTestCase {
	public function testRemoteHtmlBlockRenders(): void {
		...
		$result_html = do_blocks('
			<!-- wp:remote-data-blocks/test-html-render {"remoteData":{"blockName":"remote-data-blocks/test-html-render","queryKey":"display"}} -->
			<div>
	...
	public function testRemoteHtmlBlockRendersFallbackContent(): void {
		...
		$result_html = do_blocks('
			<!-- wp:remote-data-blocks/test-html-failure {"remoteData":{"blockName":"remote-data-blocks/test-html-failure","queryKey":"display"}} -->
			<div>
