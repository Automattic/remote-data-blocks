...
class ValidatorTest extends TestCase {
	...
	public function test_validate_nested_array_with_valid_input() {
		...
		$schema = [
			...
			'whatever' => [
				...
				'items'    => [
					'level1'        => [
						'path'  => '$.whatever.level1',
						'type'  => 'array',
						'items' => [
							'level2'       => [
								'path'  => '$.whatever.level1.level2',
								'type'  => 'array',
								'items' => [
									'key1' => [
										'path'     => '$.whatever.level1.level2.key1',
										'type'     => 'string',
										'required' => true,
									],
									'key2' => [
										'path' => '$.whatever.level1.level2.key2',
										'type' => 'integer',
									],
								],
							],
							'simple_array' => [
								'path'  => '$.whatever.level1.simple_array',
								'type'  => 'array',
								'items' => [
									'type' => 'string',
								],
	...
	public function test_validate_nested_array_with_invalid_input() {
		...
		$this->assertStringContainsString( 'config.level1.level2.key2', $result->get_error_message() );
		$this->assertStringContainsString( 'config.level1.array_field', $result->get_error_message() );
		$this->assertStringContainsString( 'config.boolean_field', $result->get_error_message() );
	}
}
