...
class PaginationTest extends TestCase {
	...
	public function test_get_pagination_input_variables_for_current_request_with_valid_query_var(): void {
		...
		MockWordPressFunctions::inject_mock_query_var(
			'rdb-pagination',
			base64_encode( wp_json_encode( [ $block_key => $query_var_value ] ) )
		);

		$result = Pagination::get_pagination_input_variables_for_current_request( $mock_query, $block_key );
	...
	public function test_get_pagination_input_variables_for_current_request_with_invalid_query_var(): void {
		...
		MockWordPressFunctions::inject_mock_query_var(
			'rdb-pagination',
			base64_encode( wp_json_encode( [ $block_key => base64_encode( wp_json_encode( 'foo' ) ) ] ) )
		);
	...
	public function test_get_pagination_input_variables_for_current_request_with_wrong_block_key(): void {
		$mock_query = MockQuery::create( [
			'input_schema' => [
				'page' => [ 'type' => 'ui:pagination_page' ],
				'per_page' => [ 'type' => 'ui:pagination_per_page' ],
